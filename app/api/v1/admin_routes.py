...
from app.schemas.admin import (
    ...
    UserFileResponse, UpdateUserRequest, PaginatedOrganizationResponse
)
...
@router.get("/users/{user_fp}/organizations", response_model=BaseResponse[PaginatedOrganizationResponse],
